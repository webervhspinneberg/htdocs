...
<body>
    <div class="wrapper">
        <div class="content" <img class="logo" src="./Logo_KPSH.jpg" />
        <?php
        require_once "./wbprofil.php";
        wbprofil($_GET, "Weiterbildungsmoeglichkeiten", "1");
        ?>
        <!--[if lt IE 7]>
            <p class="browsehappy">You are using an <strong>outdated</strong> browser. Please <a href="#">upgrade your browser</a> to improve your experience.</p>
        <![endif]-->
        <h1>Auf der Basis dieser Angaben empfehlen wir folgende Weiterbildungsangebote:</h1>
